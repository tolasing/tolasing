...
* **CAD:** Solidworks (Where the bricks get their shape)

### **🧠 Artificial Intelligence**
* **LLMs:** OpenAI GPT-4o Integration, LangChain (Giving robots a brain)
* **Vision:** OpenCV, YOLO, Object Detection/Tracking
* **Logic:** Behavior Trees (Teaching robots how to decide)

### **💻 Software Engineering**
* **Languages:** Python, C++
* **Environment:** Linux (Ubuntu), Docker, Git, GitHub Actions
