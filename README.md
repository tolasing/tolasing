...
An industrial-grade warehouse AMR designed for heavy-duty logistics.
* **Key Achievement:** Integrated ChatGPT API to translate natural language warehouse requests into ROS 2 navigation goals.
* **Tech:** ROS 2 Humble, Nav2, LiDAR SLAM, OpenAI API.

### [R.O.S.I.E.](https://github.com/tolasing/R.O.S.I.E.) 🛡️
**Robot Operating System Integrated Exoskeleton**
A prototype security robot focused on autonomous surveillance and intelligent engagement.
* **Key Achievement:** Developed a cognitive layer allowing the robot to perform threat assessment and verbal communication via LLM processing.
* **Tech:** ROS 2, OpenCV, Voice Synthesis, ChatGPT.
